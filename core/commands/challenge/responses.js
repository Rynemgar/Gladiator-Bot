...
module.exports.mention = [
  ...
  '%author% kneels before the Gladiator Emperor asking if they can take the head of %targetUser%, maybe you should pay attention and *accept the challenge oh mighty warrior!',
